...
class HomeOrderListViewCell: UITableViewCell {
    ...
    @IBOutlet weak var orderIconBtn: UIButton!
...
extension HomeOrderListViewCell {
    private func setUI() {
        ...
        orderIconBtn.isUserInteractionEnabled = false
        orderIconBtn.backgroundColor = HexColor(hex: MainColor, alpha: 0.1)
//        orderIconBtn.layer.cornerRadius = 2.5
//        orderIconBtn.layer.masksToBounds = true
        
        orderIconBtn.createButton(style: .left, spacing: 5, imageName: "order_icon", title: "予約中", cornerRadius: 2.5, color: MainColor)
